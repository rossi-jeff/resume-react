...
let Contact = () => {
  ...
  const steps = [
    { title: 'Name', content: (<FormName fieldChanged={fieldChanged} selectChanged={selectChanged} contact={contact} />) },
    { title: 'Address', content: (<FormAddress fieldChanged={fieldChanged} contact={contact} />) },
    { title: 'Contact Methods', content: (<FormContactMethod fieldChanged={fieldChanged} selectChanged={selectChanged} contact={contact} />) },
    { title: 'Message', content: (<FormMessage fieldChanged={fieldChanged} contact={contact} />) },
    { title: 'Confirm', content: (<ContactConfirm contact={contact} sendContact={sendContact} />) }
  ]
